...
})({"5KOyo":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f0c0fe6f43e1c7cf";
"use strict";
...
},{}],"el0cr":[function(require,module,exports) {
var _glightboxJs = require("./glightbox.js");
var _swiperBundleMinJs = require("./swiper-bundle.min.js");

},{"./glightbox.js":"eSjyd","./swiper-bundle.min.js":"3X3BJ"}],"eSjyd":[function(require,module,exports) {
/*!
 * GLightbox v3.2.0
 ...
 */ (function(global, factory) {
    ...
    function each(collection, callback) {
        ...
        if (isArrayLike(collection) && !isObject(collection)) {
            ...
            for(var key in collection)if (has(collection, key)) {
    ...
    function getNodeEvents(node) {
        ...
        if (name && fn && size(cache) > 0) each(cache, function(cl, i) {
    ...
    function touchNavigation(instance) {
        ...
        var touchInstance = new TouchEvents(sliderWrapper, {
            touchStart: function touchStart(e) {
                process = true;
                if (hasClass(e.targetTouches[0].target, "ginner-container") || closest(e.targetTouches[0].target, ".gslide-desc") || e.targetTouches[0].target.nodeName.toLowerCase() == "a") process = false;
                ...
                if (process) {
                    ...
                    mediaImage = null;
                    if (hasClass(media, "gslide-image")) mediaImage = media.querySelector("img");
                    var windowWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
            ...
            pressMove: function pressMove(e) {
                if (imageZoomed && !doingZoom) {
                    ...
                    if (currentScale) style += " scale3d(".concat(currentScale, ", ").concat(currentScale, ", 1)");
    ...
    var ZoomImages = function() {
        function ZoomImages(el, slide) {
            ...
            this.img.addEventListener("click", function(e) {
                ...
                if (_this.zoomedIn && !_this.dragging) _this.zoomOut();
            }, false);
    ...
    function slideImage(slide, data, index, callback) {
        ...
        img.alt = "";
        if (!isNil(data.alt) && data.alt !== "") img.alt = data.alt;
    ...
    function handleMediaFullScreen(event) {
        ...
        if (event.type === "enterfullscreen") addClass(media, "fullscreen");
    ...
    function slideInline(slide, data, index, callback) {
        ...
        var innerContent;
        if (content) {
            if (isString(content)) innerContent = createHTML('<div class="ginlined-content">'.concat(content, "</div>"));
            if (isNode(content)) {
    ...
    var SlideConfigParser = function() {
        function SlideConfigParser() {
            ...
            if (isObject(slideParamas)) this.defaults = extend(this.defaults, slideParamas);
        }
            ...
            },
            {
                ...
                value: function parseConfig(element, settings) {
                    ...
                    if (isObject(element) && !isNode(element)) {
                        if (!has(element, "type")) {
                            if (has(element, "content") && element.content) element.type = "inline";
                            else if (has(element, "href")) element.type = this.sourceType(element.href);
                        }
                    ...
                    each(data, function(val, key) {
                        if (has(settings, key) && key !== "width") data[key] = settings[key];
                        var nodeData = element.dataset[key];
                        if (!isNil(nodeData)) data[key] = _this.sanitizeValue(nodeData);
                    });
                    ...
                    if (!isNil(config)) {
                        ...
                        if (config.trim() !== "") each(data, function(val, key) {
                            var str = config;
        ...
        _createClass(Slide, [
            {
                ...
                value: function setContent() {
                    ...
                    if (hasClass(slide, "loaded")) return false;
                    var settings = this.instance.settings;
                    var slideConfig = this.slideConfig;
                    var isMobileDevice = isMobile();
                    if (isFunction(settings.beforeSlideLoad)) settings.beforeSlideLoad({
                        index: this.index,
                        slide: slide,
                        player: false
                    });
                    ...
                    if (type === "inline") {
                        ...
                        if (slideConfig.draggable) new DragSlides({
            ...
            },
            {
                ...
                value: function getConfig() {
                    if (!isNode(this.element) && !this.element.hasOwnProperty("draggable")) this.element.draggable = this.instance.settings.draggable;
        ...
        _createClass(GlightboxInit, [
            {
                ...
                value: function init() {
                    ...
                    if (selector) this.baseEvents = addEvent("click", {
                        onElement: selector,
            ...
            },
            {
                ...
                value: function open() {
                    ...
                    this.trigger("open");
                    if (isFunction(this.settings.onOpen)) this.settings.onOpen();
            ...
            },
            {
                ...
                value: function showSlide() {
                    ...
                    if (current) removeClass(current, "current");
            ...
            },
            {
                ...
                value: function preloadSlide(index) {
                    ...
                    var slideNode = this.slidesContainer.querySelectorAll(".gslide")[index];
                    if (hasClass(slideNode, "loaded")) return false;
                    var slide = this.elements[index];
                    var type = slide.type;
                    var slideData = {
                        index: index,
                    ...
                    this.trigger("slide_before_load", slideData);
                    if (type === "video" || type === "external") setTimeout(function() {
                        slide.instance.setContent(slideNode, function() {
                            _this3.trigger("slide_after_load", slideData);
                        });
                    }, 200);
                    else slide.instance.setContent(slideNode, function() {
                        _this3.trigger("slide_after_load", slideData);
                    });
                }
            },
            ...
            },
            {
                ...
                value: function insertSlide() {
                    ...
                    if (isFunction(this.settings.slideInserted)) this.settings.slideInserted({
                        index: index,
                        slide: addedSlideNode,
                        player: addedSlidePlayer
                    });
            ...
            },
            {
                ...
                value: function removeSlide() {
                    ...
                    if (isFunction(this.settings.slideRemoved)) this.settings.slideRemoved(index);
                }
            },
            {
                key: "slideAnimateIn",
                value: function slideAnimateIn(slide, first) {
                    ...
                    if (first) animateElement(slide, this.settings.cssEfects[this.settings.openEffect]["in"], function() {
                        if (_this4.settings.autoplayVideos) _this4.slidePlayerPlay(slide);
                        _this4.trigger("slide_changed", {
                            prev: prevData,
                            current: nextData
                        });
                        if (isFunction(_this4.settings.afterSlideChange)) _this4.settings.afterSlideChange.apply(_this4, [
                            prevData,
                            nextData
                        ]);
                    });
            ...
            },
            {
                ...
                value: function slideAnimateOut() {
                    ...
                    if (isFunction(this.settings.beforeSlideChange)) this.settings.beforeSlideChange.apply(this, [
                        {
                            index: this.prevActiveSlideIndex,
                            slide: this.prevActiveSlide,
                            player: this.getSlidePlayerInstance(this.prevActiveSlideIndex)
            ...
            },
            {
                ...
                value: function getSlidePlayerInstance(index) {
                    var id = "gvideo" + index;
                    var videoPlayers = this.getAllPlayers();
                    if (has(videoPlayers, id) && videoPlayers[id]) return videoPlayers[id];
                    return false;
                }
            },
            {
            ...
            },
            {
                ...
                value: function slidePlayerPlay(slide) {
                    ...
                    if (isMobile$1 && !((_this$settings$plyr$c = this.settings.plyr.config) !== null && _this$settings$plyr$c !== void 0 && _this$settings$plyr$c.muted)) return;
                    if (isNode(slide)) {
                        var node = slide.querySelector(".gvideo-wrapper");
                        if (node) slide = node.getAttribute("data-index");
                    }
            ...
            },
            {
                ...
                value: function setElements(elements) {
                    ...
                    var newElements = [];
                    if (elements && elements.length) each(elements, function(el, i) {
            ...
            },
            {
                ...
                value: function getElements() {
                    ...
                    if (!isNil(this.settings.elements) && isArray(this.settings.elements) && this.settings.elements.length) each(this.settings.elements, function(el, i) {
            ...
            },
            {
                ...
                value: function getAnimationClasses() {
                    var effects = [];
                    for(var key in this.settings.cssEfects)if (this.settings.cssEfects.hasOwnProperty(key)) {
            ...
            },
            {
                ...
                value: function build() {
                    ...
                    if (this.settings.closeButton && closeButton) this.events["close"] = addEvent("click", {
                    ...
                    if (this.nextButton) this.events["next"] = addEvent("click", {
                    ...
                    if (this.prevButton) this.events["prev"] = addEvent("click", {
                    ...
                    if (this.settings.closeOnOutsideClick) this.events["outClose"] = addEvent("click", {
                        onElement: modal,
                        withCallback: function withCallback(e, target) {
                            if (!_this7.preventOutsideClick && !hasClass(document.body, "glightbox-mobile") && !closest(e.target, ".ginner-container")) {
                                if (!closest(e.target, ".gbtn") && !hasClass(e.target, "gnext") && !hasClass(e.target, "gprev")) _this7.close();
                            }
                        }
                    });
            ...
            },
            {
                ...
                value: function resize() {
                    ...
                    if (!slide || hasClass(slide, "zoomed")) return;
                    var winSize = windowSize();
                    ...
                    var winWidth = winSize.width;
                    var winHeight = winSize.height;
                    if (winWidth <= 768) addClass(document.body, "glightbox-mobile");
                    else removeClass(document.body, "glightbox-mobile");
                    if (!video && !image) return;
                    var descriptionResize = false;
                    if (description && (hasClass(description, "description-bottom") || hasClass(description, "description-top")) && !hasClass(description, "gabsolute")) descriptionResize = true;
                    if (image) {
                        if (winWidth <= 768) var imgNode = image.querySelector("img");
                    ...
                    if (video) {
                        ...
                        if (isNumber(videoWidth) || videoWidth.indexOf("px") !== -1) maxWidth = parseInt(videoWidth);
                        else {
                        ...
                        if (maxWidth > winWidth || maxHeight > winHeight || winHeight < maxHeight && winWidth > maxWidth) {
                            ...
                            if (descriptionResize) description.setAttribute("style", "max-width: ".concat(vsize.width, "px;"));
                        } else {
                            video.parentNode.style.maxWidth = "".concat(videoWidth);
                            if (descriptionResize) description.setAttribute("style", "max-width: ".concat(videoWidth, ";"));
                        }
                    }
                }
            },
            ...
            },
            {
                ...
                value: function updateNavigationClasses() {
                    ...
                    } else if (this.index === 0 && !loop) addClass(this.prevButton, "disabled");
                    else if (this.index === this.elements.length - 1 && !loop) addClass(this.nextButton, "disabled");
                }
            },
            {
                key: "loop",
            ...
            },
            {
                ...
                value: function close() {
                    ...
                    if (!this.lightboxOpen) {
                        if (this.events) {
                            for(var key in this.events)if (this.events.hasOwnProperty(key)) this.events[key].destroy();
                            this.events = null;
                        }
                        return false;
                    }
                    ...
                    if (this.bodyHiddenChildElms.length) each(this.bodyHiddenChildElms, function(el) {
                    ...
                    animateElement(this.activeSlide, this.settings.cssEfects[this.settings.closeEffect].out, function() {
                        ...
                        _this8.built = false;
                        if (_this8.events) {
                            for(var _key in _this8.events)if (_this8.events.hasOwnProperty(_key)) _this8.events[_key].destroy();
                            _this8.events = null;
                        }
                        var body = document.body;
                        ...
                        if (isFunction(_this8.settings.onClose)) _this8.settings.onClose();
            ...
            },
            {
                ...
                value: function trigger(eventName) {
                    ...
                    if (onceTriggered.length) each(onceTriggered, function(i) {
...
},{}],"3X3BJ":[function(require,module,exports) {
/**
 * Swiper 8.3.2
        ...
        function(e) {
            ...
            function p() {
                ...
                if (t.params.loop ? (p = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup), p > a - 1 - 2 * t.loopedSlides && (p -= a - 2 * t.loopedSlides), p > u - 1 && (p -= u), p < 0 && "bullets" !== t.params.paginationType && (p = u + p)) : p = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    let i, o, u;
                    if (s.dynamicBullets && (n = a.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), r.css(t.isHorizontal() ? "width" : "height", n * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (l += p - (t.previousIndex - t.loopedSlides || 0), l > s.dynamicMainBullets - 1 ? l = s.dynamicMainBullets - 1 : l < 0 && (l = 0)), i = Math.max(p - l, 0), o = i + (Math.min(a.length, s.dynamicMainBullets) - 1), u = (o + i) / 2), a.removeClass([
                        "",
                        "-next",
                        "-next-next",
                        "-prev",
                        "-prev-prev",
                        "-main"
                    ].map((e)=>`${s.bulletActiveClass}${e}`).join(" ")), r.length > 1) a.each((e)=>{
...
},{}]},["5KOyo","el0cr"], "el0cr", "parcelRequiref99c")
